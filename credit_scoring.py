...
def predict(sk_id: int = Path(..., title="SK_ID_CURR", description="L'identifiant unique de l'individu")):
...
# Fonction pour vérifier si SK_ID_CURR existe dans la base de données (remplacer par votre propre logique)
...
# Fonction pour récupérer les données correspondant à SK_ID_CURR (remplacer par votre propre logique)
