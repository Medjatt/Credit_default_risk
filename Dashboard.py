...
if page == 'Prediction':
    ...
    st.header('Visualisation des caractéristiques du client')

    # Sélection de la caractéristique à visualiser
    feature = st.selectbox('Sélectionnez une caractéristique', features_list)
    ...
    if feature_type == 'Num':
        ...
        ax.set_title(f'Compte de {feature}')
    ...
    feature1 = st.selectbox('Sélectionnez la première caractéristique', features_list)
    ...
    feature2 = st.selectbox('Sélectionnez la deuxième caractéristique', features_list_updated)
